...
void GetTransaction(THANDLE hTdb, const char* szCode, const char* szMarket, int nDate); //逐笔成交
void GetOrder(THANDLE hTdb, const char* szCode, const char* szMarket, int nDate);//逐笔委托
void GetOrderQueue(THANDLE hTdb, const char* szCode, const char* szMarket, int nDate);//委托队列
